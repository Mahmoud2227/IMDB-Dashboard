...
def generate_visualizations(series, splits):
    ...
    fig_line_count = px.line(df1, x='year', y='count', title='Line Plot of Movie Count Over Time')
    ...
    fig_line_votes = px.line(df2, x='year', y='votes', title='Line Plot of votes Over Time')
